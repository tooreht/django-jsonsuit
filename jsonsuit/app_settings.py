...
SYNTAX_HIGHLIGHTER_JS = getattr(
    settings, "JSONSUIT_SYNTAX_HIGHLIGHTER_JS", ("jsonsuit/js/prism.js",)
)
SYNTAX_HIGHLIGHTER_CSS = getattr(
    settings,
    "JSONSUIT_SYNTAX_HIGHLIGHTER_CSS",
...
READONLY_WIDGET_MEDIA_JS = getattr(
    settings,
    "JSONSUIT_READONLY_WIDGET_MEDIA_JS",
    SYNTAX_HIGHLIGHTER_JS + ("jsonsuit/js/readonly-jsonsuit.js",),
)
READONLY_WIDGET_MEDIA_CSS = getattr(
    settings,
